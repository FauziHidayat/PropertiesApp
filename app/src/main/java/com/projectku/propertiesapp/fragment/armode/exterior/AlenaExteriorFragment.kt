package com.projectku.propertiesapp.fragment.armode.exterior
...
class AlenaExteriorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_alena_exterior, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        modelNode.loadModelAsync(context = requireContext(),
            lifecycle = lifecycle,
            glbFileLocation = "models/exterior/alenaexterior.glb",
            onLoaded = {
